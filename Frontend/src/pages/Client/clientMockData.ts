    ...
    banners: [
      {
        ...
        description: '24x7 Dedicated InsuMitra desk for cashless pre-auth approvals across 14,000+ network hospitals nationwide.',
        imageUrl: 'https://images.unsplash.com/photo-1538108149393-fbbd81895907?w=600&auto=format&fit=crop&q=80',
        tag: 'Health Care',
        actionLabel: 'Claim Desk',
        actionUrl: '/client/claims',
      },
      {
        id: 'b2',
        title: 'Super Top-Up 1 Crore Cover @ ₹250/mo',
        description: 'Protect your family against high hospitalization bills with deductible top-up plans from top insurers.',
      ...
      },
      {
        ...
        description: 'Download your annual consolidated premium tax receipts in one click from your documents vault.',
      ...
      {
        id: 'b4',
        title: 'Zero Dep Car & Motor Insurance Renewal',
        description: 'Get instant policy copy in 2 minutes with roadside assistance and fast track claim settlement.',
        imageUrl: 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?w=600&auto=format&fit=crop&q=80',
        tag: 'Motor Protection',
        actionLabel: 'View Coverages',
        actionUrl: '/client/policies',
      }
    ],
  },
